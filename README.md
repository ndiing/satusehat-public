...
-   **<code>post</code> [/satusehat/v1/Organization](./rest/satusehat-mapping/organization.http)** - [Create Organization](./docs/satusehat-mapping/organization.md)

#### Location

-   **<code>post</code> [/satusehat/v1/Location](./rest/satusehat-mapping/location.http)** - [Create Location](./docs/satusehat-mapping/location.md)

#### Encounter

-   **<code>post</code> [/satusehat/v1/Encounter](./rest/satusehat-mapping/encounter.http)** - [Create Encounter](./docs/satusehat-mapping/encounter.md)
